...
yfs_client::lock_flush::lock_flush(extent_client *temp)
	:flush_ec(temp)
{
}

void
yfs_client::lock_flush::dorelease(lock_protocol::lockid_t lid)
{
	flush_ec->flush(lid);
}
...
yfs_client::yfs_client(std::string extent_dst, std::string lock_dst)
{
  ...
  lc = new lock_client_cache(lock_dst, new lock_flush(ec));
